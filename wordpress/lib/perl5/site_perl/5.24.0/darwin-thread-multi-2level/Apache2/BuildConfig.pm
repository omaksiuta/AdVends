...
'MODPERL_CC' => 'cc',
'MODPERL_CCCDLFLAGS' => ' ',
'MODPERL_CCOPTS' => ' -fno-common -DPERL_DARWIN -mmacosx-version-min=10.9 -fno-strict-aliasing -pipe -fstack-protector -DPERL_USE_SAFE_PUTENV -I/Applications/MAMP/Library/lib/perl5/5.24.0/darwin-thread-multi-2level/CORE -DMOD_PERL -DMP_COMPAT_1X -std=gnu89 -DDARWIN -DSIGPROCMASK_SETS_THREAD_MASK',
'MODPERL_CP' => 'cp',
'MODPERL_CPPRUN' => 'cc  -E',
...
'MODPERL_LDOPTS' => '   -mmacosx-version-min=10.9 -fstack-protector -L/usr/local/lib  -L/Applications/MAMP/Library/lib/perl5/5.24.0/darwin-thread-multi-2level/CORE -lperl -lpthread -ldl -lm -lutil -lc',
