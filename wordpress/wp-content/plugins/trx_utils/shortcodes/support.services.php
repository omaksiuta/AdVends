...
if ( !function_exists( 'sweet_dessert_sc_services' ) ) {
	...
	sweet_dessert_require_shortcode('trx_services', 'sweet_dessert_sc_services');
}
...
if ( !function_exists( 'sweet_dessert_sc_services_item' ) ) {
	...
	sweet_dessert_require_shortcode('trx_services_item', 'sweet_dessert_sc_services_item');
}
// ---------------------------------- [/trx_services] ---------------------------------------
