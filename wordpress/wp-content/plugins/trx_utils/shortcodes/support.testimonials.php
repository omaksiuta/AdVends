...
if (!function_exists('sweet_dessert_sc_testimonials')) {
	...
	sweet_dessert_require_shortcode('trx_testimonials', 'sweet_dessert_sc_testimonials');
}
...
if (!function_exists('sweet_dessert_sc_testimonials_item')) {
	...
	sweet_dessert_require_shortcode('trx_testimonials_item', 'sweet_dessert_sc_testimonials_item');
}
// ---------------------------------- [/trx_testimonials] ---------------------------------------
