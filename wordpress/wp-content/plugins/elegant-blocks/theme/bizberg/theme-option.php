        ...
        <div class="bizberg_header">
        	<div class="bizberg_container">
	        	<div class="bizberg_header_left">
	        		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/bizberg.png' ); ?>">
        ...
        <div class="bizberg_container">
        	...
        	<div class="column_60">
	    		...
	    		<div class="customizer_settings pro">
		    		...
		    		<h3><?php esc_html_e( 'Elegant Blocks for Bizberg', 'elegant-blocks' ); ?></h3>
	    	...
	    	<div class="column_40">
	    		...
	    		<div class="customizer_settings import_site_wrapper">    		
		    		...
		    		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/bizberg-starter-sites.jpg' ); ?>">
		    	...
		    	<div class="customizer_settings support_wrapper">    		
		    		...
		    		<p>If you have any problem, visit our <a href="<?php echo esc_url( elegant_blocks_bizberg_get_support_forum_link() ); ?>" target="_blank">support forum</a>.</p>		    		
		    	</div>
		    	...
		    	<div class="customizer_settings review_wrapper">    		
		    		...
		    		<p>If you like the theme please give us a 5 star rating. <a href="https://wordpress.org/support/theme/bizberg/reviews/?rate=5#new-post" target="_blank">Click here</a> to show your love.</p>
		    	</div>
			    
		    	<?php
		    	if( empty( elegant_blocks_bizberg_pro_status() ) ){ ?>
...
function elegant_blocks_bizberg_pro_status(){

	$theme = wp_get_theme();

	switch ( !empty( $theme->parent() ) ? $theme->parent()->get( 'TextDomain' ) : $theme->get( 'TextDomain' ) ) {
...
function elegant_blocks_bizberg_get_support_forum_link(){
	...
	switch ( !empty( $theme->parent() ) ? $theme->parent()->get( 'TextDomain' ) : $theme->get( 'TextDomain' ) ) {
		...
		case 'bizberg':
			return 'https://cyclonethemes.com/forums/forum/free-version/bizberg-lite/';
			break;

		case 'bizberg-pro':
			return 'https://cyclonethemes.com/forums/forum/premium-version/bigberg-pro/';
			break;
