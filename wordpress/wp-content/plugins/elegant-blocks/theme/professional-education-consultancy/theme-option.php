...
function elegant_blocks_register_theme_page() {
    add_submenu_page(
        'themes.php',
        esc_attr__( 'Professional Education Consultancy Options', 'elegant-blocks' ),
        esc_attr__( 'Professional Education Consultancy Options', 'elegant-blocks' ),
        'manage_options',
        ...
        <div class="bizberg_header">
        	<div class="bizberg_container">
	        	<div class="bizberg_header_left">
	        		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/professional-education-consultancy.png' ); ?>">
        ...
        <div class="bizberg_container">
	    	...
	    	<div class="column_40">
	    		...
	    		<div class="customizer_settings import_site_wrapper">    		
		    		...
		    		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/education-starter-sites.jpg' ); ?>">
		    	...
		    	<div class="customizer_settings review_wrapper">    		
		    		...
		    		<p>If you like the theme please give us a 5 star rating. <a href="https://wordpress.org/support/theme/professional-education-consultancy/reviews/?rate=5#new-post" target="_blank">Click here</a> to show your love.</p>
		    	</div>
		    	...
		    	if( empty( elegant_blocks_professional_education_consultancy_pro_status() ) ){ ?>
			    	<div class="customizer_settings upgrade_wrapper">    		
			    		...
			    		<p>If you love the free version then you will love the PRO Version. With more features and more options. <a href="https://cyclonethemes.com/downloads/professional-education-consultancy-pro/" target="_blank">Click Here</a> to buy the PRO Version.</p>
			    	</div>
			    	<?php 
		    	} ?>
...
function elegant_blocks_professional_education_consultancy_get_support_forum_link(){
	...
	switch ( $theme->get( 'TextDomain' ) ) {
		...
		case 'professional-education-consultancy-pro':
			return 'https://cyclonethemes.com/forums/forum/premium-version/professional-education-consultancy-pro/';
			break;

		case 'professional-education-consultancy':
			return 'https://cyclonethemes.com/forums/forum/free-version/professional-education-consultancy-lite/';
			break;
