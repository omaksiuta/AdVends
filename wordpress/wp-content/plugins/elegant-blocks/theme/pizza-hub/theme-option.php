        ...
        <div class="bizberg_header">
        	<div class="bizberg_container">
	        	<div class="bizberg_header_left">
	        		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/pizza-hub.png' ); ?>">
        ...
        <div class="bizberg_container">
        	...
        	<div class="column_60">
	    		...
	    		<div class="customizer_settings pro">
		    		...
		    		<h3><?php esc_html_e( 'Elegant Blocks for Pizza Hub', 'elegant-blocks' ); ?></h3>
	    	...
	    	<div class="column_40">
	    		...
	    		<div class="customizer_settings import_site_wrapper">    		
		    		...
		    		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/pizza-hub-starter-sites.jpg' ); ?>">
		    	...
		    	<div class="customizer_settings support_wrapper">    		
		    		...
		    		<p>If you have any problem, visit our <a href="<?php echo esc_url( elegant_blocks_pizza_hub_get_support_forum_link() ); ?>" target="_blank">support forum</a>.</p>		    		
		    	</div>
		    	...
		    	<div class="customizer_settings review_wrapper">    		
		    		...
		    		<p>If you like the theme please give us a 5 star rating. <a href="https://wordpress.org/support/theme/pizza-hub/reviews/?rate=5#new-post" target="_blank">Click here</a> to show your love.</p>
		    	</div>
			    
		    	<?php
		    	if( empty( elegant_blocks_pizza_hub_pro_status() ) ){ ?>
			    	<div class="customizer_settings upgrade_wrapper">    		
			    		...
			    		<p>If you love the free version then you will love the PRO Version. With more features and more options. <a href="https://cyclonethemes.com/downloads/pizza-hub-pro/" target="_blank">Click Here</a> to buy the PRO Version.</p>
			    	</div>
			    	<?php 
		    	} ?>
...
function elegant_blocks_pizza_hub_pro_status(){
...
function elegant_blocks_pizza_hub_get_support_forum_link(){
	...
	switch ( $theme->get( 'TextDomain' ) ) {
		...
		case 'pizza-hub':
			return 'https://cyclonethemes.com/forums/forum/free-version/pizza-hub-lite/';
			break;

		case 'pizza-hub-pro':
			return 'https://cyclonethemes.com/forums/forum/premium-version/pizza-hub-pro/';
			break;
