...
//Show Filter Options
$show_filter = Integrio_Theme_Helper::get_option('portfolio_list_show_filter');
$list_terms =  Integrio_Theme_Helper::get_option('portfolio_list_filter_cats');
...
$defaults = array(
    ...
    'show_view_all' => 'no',
    'click_area' => 'single',
    'posts_per_row' => Integrio_Theme_Helper::get_option('portfolio_list_columns'),
    'item_el_class' => '', 
    'css' => '',
    'show_portfolio_title' => Integrio_Theme_Helper::get_option('portfolio_list_show_title'),
    'show_content' => Integrio_Theme_Helper::get_option('portfolio_list_show_content'),
    'show_meta_categories' => Integrio_Theme_Helper::get_option('portfolio_list_show_cat'),
    'view_style' => 'ajax',
...
extract($defaults);
$layout = Integrio_Theme_Helper::get_option('portfolio_list_sidebar_layout');
$sidebar = Integrio_Theme_Helper::get_option('portfolio_list_sidebar_def');
$column = 12;
            ...
            <div id='main-content' class="wgl_col-<?php echo (int)$column; ?>">
                ...
                if(!empty($term_id)){
                    echo '<div class="portfolio_archive-cat">';
                        echo '<h4 class="portfolio_archive-cat_title">'.esc_html__('Category:','integrio-core').' '.esc_html($cat_title).'</h4>';
