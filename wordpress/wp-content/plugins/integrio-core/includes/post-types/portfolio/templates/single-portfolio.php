...
$sb = Integrio_Theme_Helper::render_sidebars('portfolio_single');
...
<div class="wgl-container single_portfolio">
	<div class="row<?php echo esc_attr($row_class); ?>">
		<div id='main-content' class="wgl_col-<?php echo (int)$column; ?>">
			...
			$related_switch = Integrio_Theme_Helper::get_option('portfolio_related_switch');
			...
			if ( (bool)$related_switch && class_exists('Vc_Manager')) :
				...
				$mb_pf_carousel_r = Integrio_Theme_Helper::options_compare('pf_carousel_r', 'mb_portfolio_related_switch', 'on');
				$mb_pf_title_r = Integrio_Theme_Helper::options_compare('pf_title_r', 'mb_portfolio_related_switch', 'on');
				$mb_pf_column_r = Integrio_Theme_Helper::options_compare('pf_column_r', 'mb_portfolio_related_switch', 'on');
				$mb_pf_number_r = Integrio_Theme_Helper::options_compare('pf_number_r', 'mb_portfolio_related_switch', 'on');
				...
				if($featured_render->post_count > 0){
					echo '<div class="related_portfolio">';
						if(!empty($mb_pf_title_r)){
							echo '<div class="integrio_module_title"><h4>' . esc_html($mb_pf_title_r) . '</h4></div>';
						}
						echo $featured_post;
					echo '</div>';
				}
