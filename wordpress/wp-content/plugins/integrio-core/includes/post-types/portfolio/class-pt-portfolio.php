...
class Portfolio {
    ...
    public function __construct() {
        ...
        $this->name = __( 'Portfolio', 'integrio-core' );
        $this->singular_name = __( 'Item', 'integrio-core' );
        $this->plural_name = __( 'Items', 'integrio-core' );

        $this->slug = Integrio_Theme_Helper::get_option('portfolio_slug') != '' ? Integrio_Theme_Helper::get_option('portfolio_slug') : 'portfolio';
    ...
    public function register() {
        $labels = array(
            ...
            'add_new'            => sprintf( __('Add New %s', 'integrio-core' ), $this->singular_name ),
            'add_new_item'       => sprintf( __('Add New %s', 'integrio-core' ), $this->singular_name ),
            'edit_item'          => sprintf( __('Edit %s', 'integrio-core'), $this->singular_name ),
            'new_item'           => sprintf( __('New %s', 'integrio-core'), $this->singular_name ),
    ...
    public function register_taxonomy() {
        ...
        $labels = array(
            'name'              => sprintf( __( '%s Categories', 'integrio-core' ), $this->name ),
            'menu_name'         => sprintf( __( '%s Categories','integrio-core' ), $this->name ),
            'singular_name'     => sprintf( __( '%s Category', 'integrio-core' ), $this->name ),
            'search_items'      => sprintf( __( 'Search %s Categories', 'integrio-core' ), $this->name ),
            'all_items'         => sprintf( __( 'All %s Categories','integrio-core' ), $this->name ),
            'parent_item'       => sprintf( __( 'Parent %s Category','integrio-core' ), $this->name ),
            'parent_item_colon' => sprintf( __( 'Parent %s Category:','integrio-core' ), $this->name ),
            'new_item_name'     => sprintf( __( 'New %s Category Name','integrio-core' ), $this->name ),
            'add_new_item'      => sprintf( __( 'Add New %s Category','integrio-core' ), $this->name ),
            'edit_item'         => sprintf( __( 'Edit %s Category','integrio-core' ), $this->name ),
            'update_item'       => sprintf( __( 'Update %s Category','integrio-core' ), $this->name ),
        );
        $args = array(
            'labels' => $labels,
            'hierarchical' => true,
    ...
    public function register_taxonomy_tag() { // Second part of taxonomy name
        ...
        $labels = array(
            'name' => __( 'Tags', 'integrio-core' ),
            'menu_name' => __( 'Tags','integrio-core' ),
            'singular_name' => __( 'Tag', 'integrio-core' ),
            'popular_items' => __( 'Popular Tags', 'integrio-core' ),
            'search_items' =>  __( 'Search Tag', 'integrio-core' ),
            'all_items' => __( 'All Tags','integrio-core' ),
            'parent_item' => null,
            'parent_item_colon' => null,
            'new_item_name' => __( 'New Tag Name','integrio-core' ),
            'add_new_item' => __( 'Add New Tag','integrio-core' ),
            'edit_item' => __( 'Edit Tag','integrio-core' ),
            'update_item' => __( 'Update Tag','integrio-core' ),
        );
        $args = array(
            'labels' => $labels,
            'hierarchical' => false,
    ...
    function column_image_name ($columns) {
        ...
        $array2 = array('image' => __( 'Featured Image', 'integrio-core' ));
