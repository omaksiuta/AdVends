...
class WglTeam {
	...
	public function render($atts, $content = null){
		...
		$header_font = esc_attr(Integrio_Theme_Helper::get_option('header-font')['color']);
		...
		<div <?php echo esc_attr($team_id_attr); ?> class="wgl_module_team <?php echo esc_attr($team_classes); ?>">
			<div class="team-items_wrap" <?php echo Integrio_Theme_Helper::render_html($style_gap);?> >
				<?php
				switch ((bool)$use_carousel) {
					case true: echo do_shortcode('[wgl_carousel '.$carousel_options.']'.$team_items.'[/wgl_carousel]'); break;
					default: echo Integrio_Theme_Helper::render_html($team_items); break;
				}
				?>
			</div>
		</div>
