...
class Team {
    ...
    public function __construct() {
        ...
        $this->name = __( 'Team', 'integrio-core' );
        $this->singular_name = __( 'Member', 'integrio-core' );
        $this->plural_name = __( 'Members', 'integrio-core' );

        $this->slug = Integrio_Theme_Helper::get_option('team_slug') != '' ? Integrio_Theme_Helper::get_option('team_slug') : 'team';
...
function render_wgl_team_item ( $single_member = false, $item_atts, $team_image_dims ) {
    ...
    if (!(bool)$single_member) {
        ...
        $excerpt = Integrio_Theme_Helper::modifier_character($excerpt_stripe_tags, $letter_count, "");
    }
...
function render_wgl_team ($atts) {
    ...
    switch ($posts_per_line) { 
        ...
        case '3': $team_image_dims = array('width' => '740', 'height' => '840');  break;
        case '4':
        case '5': $team_image_dims = array('width' => '364', 'height' => '470');  break;
    }
    
    list($query_args) = Integrio_Loop_Settings::buildQuery($item_atts);
