...
function wgl_extra_user_profile_fields( $user ) { ?>
    <h3><?php esc_html_e("Extra profile information", "integrio-core"); ?></h3>

    <table class="form-table">
    <tr>
        <th><label for="instagram"><?php esc_html_e("Instagram", "integrio-core"); ?></label></th>
        <td>
            <input type="text" name="instagram" id="instagram" value="<?php echo esc_attr( get_the_author_meta( 'instagram', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your instagram url.", "integrio-core"); ?></span>
        </td>
    </tr>
    <tr>
        <th><label for="facebook"><?php esc_html_e("Facebook", "integrio-core"); ?></label></th>
        <td>
            <input type="text" name="facebook" id="facebook" value="<?php echo esc_attr( get_the_author_meta( 'facebook', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your facebook url.", "integrio-core"); ?></span>
        </td>
    </tr>
    <tr>
    <th><label for="linkedin"><?php esc_html_e("Linkedin", "integrio-core"); ?></label></th>
        <td>
            <input type="text" name="linkedin" id="linkedin" value="<?php echo esc_attr( get_the_author_meta( 'linkedin', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your linkedin url.", "integrio-core"); ?></span>
        </td>
    </tr>
    <tr>
    <th><label for="twitter"><?php esc_html_e("Twitter", "integrio-core"); ?></label></th>
        <td>
            <input type="text" name="twitter" id="twitter" value="<?php echo esc_attr( get_the_author_meta( 'twitter', $user->ID ) ); ?>" class="regular-text" /><br />
            <span class="description"><?php esc_html_e("Please enter your twitter url.", "integrio-core"); ?></span>
        </td>
    </tr>
    </table>
<?php }
...
function wgl_custom_fields(){
    if (class_exists('Vc_Manager')) {
        ...
        vc_add_shortcode_param('integrio_radio_image', 'integrio_radio_image', $gtdu.'/wpb/addon_fields/js/wgl_vc_extenstions.js');
        vc_add_shortcode_param('dropdown_multi','integrio_dropdown_field');
        vc_add_shortcode_param('wgl_checkbox', 'integrio_checkbox_custom', $gtdu.'/wpb/addon_fields/js/wgl_vc_extenstions.js');
        vc_add_shortcode_param('integrio_param_heading', 'integrio_heading_line');
    }
}
...
function wgl_wp_head_custom_code() {
    ...
    if (class_exists('Integrio_Theme_Helper')) {
        $header_custom_code = Integrio_Theme_Helper::get_option('header_custom_js');
    }
...
function wgl_custom_footer_js() {
     if (class_exists('Integrio_Theme_Helper')) {
        $custom_js = Integrio_Theme_Helper::get_option('custom_js');
    }
