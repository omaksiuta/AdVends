...
if (!class_exists('Integrio_header_sticky')) {
	class Integrio_header_sticky extends Integrio_get_header{

		public function __construct(){
			$this->header_vars();  
			$this->html_render = 'sticky';

	   		if (Integrio_Theme_Helper::options_compare('header_sticky','mb_customize_header_layout','custom') == '1') {
	   			$header_sticky_style = Integrio_Theme_Helper::get_option('header_sticky_style');
	   			$header_sticky_background = Integrio_Theme_Helper::get_option('header_sticky_background');
	   			$header_sticky_color = Integrio_Theme_Helper::get_option('header_sticky_color');
	   			$header_sticky_border = Integrio_Theme_Helper::get_option('header_sticky_border');
	   			$header_sticky_border_height = Integrio_Theme_Helper::get_option('header_sticky_border_height');
	   			$header_sticky_border_color = Integrio_Theme_Helper::get_option('header_sticky_border_color');
	   			$header_sticky_shadow = Integrio_Theme_Helper::get_option('header_sticky_shadow');
