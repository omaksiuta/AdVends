<?php
	...
	$show_likes = Integrio_Theme_Helper::get_option('single_likes');
	$show_share = Integrio_Theme_Helper::get_option('single_share');
	$show_views = Integrio_Theme_Helper::get_option('single_views');
	$single_author_info = Integrio_Theme_Helper::get_option('single_author_info');
	$single_meta = Integrio_Theme_Helper::get_option('single_meta');
	$single_cats = Integrio_Theme_Helper::get_option('single_meta_categories');
	$show_tags = Integrio_Theme_Helper::get_option('single_meta_tags');
	$single->set_post_views(get_the_ID());

	$meta_args = $meta_args_cats = array();
 
	if ( !(bool)$single_meta ) {
		$meta_args['author'] = !(bool)Integrio_Theme_Helper::get_option('single_meta_author');
		$meta_args['date'] = !(bool)Integrio_Theme_Helper::get_option('single_meta_date');
		$meta_args['comments'] = !(bool)Integrio_Theme_Helper::get_option('single_meta_comments');
		$meta_args_cats['category'] = !(bool)Integrio_Theme_Helper::get_option('single_meta_categories');	
	} 
		...
		<div class="item_wrapper">
			<div class="blog-post_content">
				...
				<?php
					...
					wp_link_pages(array('before' => '<div class="page-link"><span class="pagger_info_text">' . esc_html__('Pages', 'integrio') . ': </span>', 'after' => '</div>'));
