...
$sb = Integrio_Theme_Helper::render_sidebars('single');
...
<div class="wgl-container">
        <div class="row<?php echo apply_filters('integrio_row_class', $row_class); ?>">
			<div id='main-content' class="wgl_col-<?php echo apply_filters('integrio_column_class', $column); ?>">
				...
				$show_post_related = Integrio_Theme_Helper::get_option('single_related_posts');
				if ( (bool)$show_post_related && class_exists('Vc_Manager')) : ?>
					...
					<?php
						...
						echo '<div class="integrio_module_title"><h4>'.(!empty($mb_blog_title_r) ? esc_html($mb_blog_title_r) : esc_html__('Related Posts', 'integrio')) .' </h4></div>';
