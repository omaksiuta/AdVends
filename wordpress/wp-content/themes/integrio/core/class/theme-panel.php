    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            add_menu_page (
                esc_html__('WebGeniusLab', 'integrio'),
                esc_html__('WebGeniusLab', 'integrio'), 
            ...
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'integrio'),    //page_title
                esc_html__('Welcome', 'integrio'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'integrio'),   //page_title
                    esc_html__('Theme Plugins', 'integrio'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'integrio'),   //page_title
                esc_html__('Requirements', 'integrio'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'integrio'),   //page_title
                esc_html__('Activate Theme', 'integrio'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'integrio'),   //page_title
                esc_html__('Help Center', 'integrio'),   //menu_title
                'edit_posts',                           //capability
            ...
            if ( class_exists( 'Integrio_Core' ) ) {
                $submenu[] = array(
                    esc_html__('Theme Options', 'integrio'),   //page_title
                    esc_html__('Theme Options', 'integrio'),   //menu_title
                    'edit_posts',                           //capability
