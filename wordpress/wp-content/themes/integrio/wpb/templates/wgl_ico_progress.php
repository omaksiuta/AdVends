...
?>
    ...
    <div <?php echo esc_attr($ico_attr); echo Integrio_Theme_Helper::render_html($ico_style_attr); ?> class="integrio_module_ico_progress<?php echo esc_attr($ico_wrap_classes) ?>">
