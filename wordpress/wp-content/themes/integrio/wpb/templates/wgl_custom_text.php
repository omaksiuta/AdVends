<?php
	...
	// Render Google Fonts
	extract( Integrio_GoogleFontsRender::getAttributes( $atts, $this, array('google_fonts_text') ) );
	...
	if(!empty($content)){
		echo '<div class ="integrio_module_text'.esc_attr($class).'"'.(!empty($style) ? ' style="'.$style.'"' : '').'>';
