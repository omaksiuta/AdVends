<?php
        ...
        $content .= '<div class="cats_item-wrap">';
            $content .= '<div class="cats_item" '.$item_wrap_styles.'>';
                $content .= '<a class="cats_item-link" href="'.esc_url($cat_link).'">';
                    ...
                    $content .= '<h6 class="cats_item-count" '.$count_styles.'>'.$count.esc_html__( ' News', 'integrio' ).'</h6>';
                $content .= '</a>';
            $content .= '</div>';
        $content .= '</div>';
    }
    ...
    $output .= '<div class="integrio_module_cats clearfix'.esc_attr($cats_wrap_classes).'">';
        if ((bool)$use_carousel) {
