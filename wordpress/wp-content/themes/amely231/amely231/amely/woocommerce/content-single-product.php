...
if ( $product_page_layout == 'image-slider' ) {
	$summary_classes = array( 'col-lg-12', 'summary', 'entry-summary' );
}
		...
		<div class="<?php echo esc_attr( $page_wrap_class ); ?>">
			<div class="<?php echo esc_attr( $content_class ); ?>">
				...
				<div
					...
					<div
						class="<?php echo '' . ( $product_page_layout == 'image-slider' ) ? 'col-lg-12' : 'col-lg-6' ?> product-images">
						<?php
						/**
