/**
 * Sweet Dessert Framework: Admin scripts
 *
...
jQuery(document).ready(function() {
	...
	jQuery('.widgets_param_post_type_selector').on('change', function() {
		...
		sweet_dessert_admin_fill_categories(this, cat_fld, cat_lbl);
		return false;
	});
	// Set parent course
	jQuery('.sweet_dessert_course_selector').on('click', function(e) {
		"use strict";
...
function sweet_dessert_admin_fill_categories(fld, cat_fld, cat_lbl) {
	"use strict";
	var cat_value = sweet_dessert_get_listbox_selected_value(cat_fld.get(0));
