<?php
/**
 * Sweet Dessert Framework: http queries and data manipulations
 *
...
if (!function_exists('sweet_dessert_get_value_gps')) {
	function sweet_dessert_get_value_gps($name, $defa='', $page='') {
		...
		if ($putToSession)
			sweet_dessert_set_session_value($name, $rez, $page);
		return $rez;
	}
}
...
if (!function_exists('sweet_dessert_set_session_value')) {
	function sweet_dessert_set_session_value($name, $value, $page='') {
...
// Save value into session
if (!function_exists('sweet_dessert_del_session_value')) {
	function sweet_dessert_del_session_value($name, $page='') {
		if (!session_id()) session_start();
...
if (!function_exists('sweet_dessert_get_protocol')) {
	function sweet_dessert_get_protocol() {
