...
if ($post_data['post_edit_enable']) {
	...
	wp_enqueue_style ( 'frontend-editor-style', sweet_dessert_get_file_url('js/core.editor/core.editor.css'), array(), null );
	wp_enqueue_script( 'frontend-editor',       sweet_dessert_get_file_url('js/core.editor/core.editor.js'),  array(), null, true );
