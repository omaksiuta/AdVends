...
if ( !function_exists( 'sweet_dessert_template_news_portfolio_theme_setup' ) ) {
	add_action( 'sweet_dessert_action_before_init_theme', 'sweet_dessert_template_news_portfolio_theme_setup', 1 );
	function sweet_dessert_template_news_portfolio_theme_setup() {
		sweet_dessert_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'sweet-dessert'),
...
// Template output
if ( !function_exists( 'sweet_dessert_template_news_portfolio_output' ) ) {
	function sweet_dessert_template_news_portfolio_output($post_options, $post_data) {
