...
<div class="col-md-7 col-sm-12">
	<h2 class="reciept_heading"><?php echo apply_filters( 'edd_payment_receipt_products_title', __( 'Products Bought', 'mayosis' ) ); ?></h2>
					...
					<td>
						...
						<ul class="edd_purchase_receipt_files">
							...
							elseif ( edd_is_bundled_product( $item['id'] ) ) :
								...
								echo '<li>' . apply_filters( 'edd_receipt_no_files_found_text', __( 'No downloadable files found.', 'mayosis' ), $item['id'] ) . '</li>';
							endif; ?>
						</ul>
						<?php endif; ?>
