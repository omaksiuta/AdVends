...
$producthoverbottom= get_theme_mod( 'product_hover_bottom','share' );
?>
                                                           
                                                           <?php if ($producthoverbottom =='cart'): ?>
                                                            <?php 
