...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>">
	<div
		class="col-xs-12<?php if ( $thumbnails_position == 'left' && $attachment_ids && ! $show_only_featured_images ) : ?> <?php echo '' . ( $product_page_layout == 'image-slider' ) ? '' : 'col-md-9' ?><?php endif; ?>">
	...
	<?php if ( $product_page_layout != 'sticky' && $product_page_layout != 'sticky-fullwidth' && $product_page_layout != 'image-slider' && ! $show_only_featured_images ) {
		?>
		<div
